...
from Itachi.utils.database import add_sudo, remove_sudo
from Itachi.utils.decorators.language import language
from Itachi.utils.extraction import extract_user
...
@app.on_message(filters.command(["sudolist", "listsudo", "sudoers"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.user(OWNER_ID))
@language
