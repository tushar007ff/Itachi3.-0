...
from Itachi.utils.decorators.admins import ActualAdminCB
from Itachi.utils.decorators.language import language, languageCB
from Itachi.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from Itachi.utils.inline.start import private_panel
from config import BANNED_USERS, OWNER_ID


@app.on_message(
    filters.command(["setting"]) & filters.group & ~BANNED_USERS
)
@language
